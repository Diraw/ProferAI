  ...
  theme: {
    extend: {
      colors: {
        ...
        'workspace-canvas': 'hsl(var(--workspace-canvas, var(--sunken-surface)) / <alpha-value>)',
        'panel-surface': 'hsl(var(--panel-surface, var(--raised-surface)) / <alpha-value>)',
        'panel-border': 'hsl(var(--panel-border, var(--surface-border)) / <alpha-value>)',
